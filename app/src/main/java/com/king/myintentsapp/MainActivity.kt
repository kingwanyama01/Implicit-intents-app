...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBtnSms.setOnClickListener {
            sendSMS("0735427864","Hello Sir....")
        }

        mBtnShare.setOnClickListener {
            share("Hello guyz..Kindly visit www.ourclass.com to join my class")
        }

        mBtnEmail.setOnClickListener {
            email("abcdef@gmail.com","JOB APPLICATION","Hello sir......")
        }
